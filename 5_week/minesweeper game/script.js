...
function discoverCell(row, col) {
  ...
  if(adjacentBombs === 0) {
    discoverCell(row-1,col); //discover up
    discoverCell(row-1,col-1); //discover left up diagonal
    discoverCell(row,col-1); //discover left
    // discoverCell(row+1,col+1); //discover left down diagonal
  }

  console.log('test', adjacentBombs);
  // discoverCell(row+1,col+1); //discover left down diagonal
